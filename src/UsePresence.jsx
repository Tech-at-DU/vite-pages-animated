...
const colors = ['tomato', 'gold', 'cornflowerblue', 'lime', 'pink', 'tomato']
...
export default function UsePresenceData() {
  ...
  const color = colors[selectedItem] // `var(--hue-${selectedItem})`
  ...
  return (
    <div style={container}>
      ...
      {/* use AnimatePresence to manage dynamic elements */}
      <AnimatePresence
          custom={direction}
          initial={false}
          mode="popLayout"
      >
        {/* Slides are created and removed from the DOM dynamically */}
